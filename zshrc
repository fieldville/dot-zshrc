...
plugins=(ant brew bundler compleat gem git github heroku history-substring-search node osx rails rails3 rake ruby rbenv svn vi-mode debian perl vagrant cap ssh-agent)
