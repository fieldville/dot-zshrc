...
plugins=(ant brew bundler compleat gem git git-extras git-flow git-remote-branch github heroku history node npm osx rails rake ruby rbenv svn vi-mode perl vagrant cap ssh-agent mvn sublime history-substring-search autojump)
